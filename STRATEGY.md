...
>
> 🎓 **심화판 — 인터랙티브 정석·사활 문제집 + 해설 기보(역전 게임 복기) + 단계별 전략 + 용어 사전은 → [strategy.html](strategy.html)** 에서 보세요. (브라우저로 열면 보드·정답·승률 차트가 그려집니다.)
...
> 4. **"출구 4방 이웃을 잡아라."** — 탈출은 출구 뒤 *받침*이 있어야만 성립. 종반 출구 이웃 점유는 **승자 14 : 패자 2**(7배). 이 4칸을 두고 싸운다.
